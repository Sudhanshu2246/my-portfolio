...
export default function Contact() {
  ...
  const inputClass =
    "w-full bg-transparent py-3 text-[15px] text-white outline-none transition-colors placeholder:text-[#8F8F8F]/40";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 70% at 20% 60%, rgba(200,100,20,0.07) 0%, transparent 70%)",
        }}
      />
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background:
            "radial-gradient(ellipse 50% 60% at 80% 40%, rgba(0,229,168,0.05) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 grid h-full w-full max-w-[1400px] grid-cols-1 gap-12 px-12 py-20 md:grid-cols-2 md:px-20 lg:px-32">
        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <a
            ...
            className="font-display text-[22px] font-bold transition-colors hover:opacity-80 md:text-[28px]"
            style={{
          ...
          <div className="flex items-center gap-3">
            <span
              ...
              style={{ background: "#00E5A8", boxShadow: "0 0 8px #00E5A8" }}
            />
            <span
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            ...
            <div>
              ...
              <div
                className="border-b transition-colors focus-within:border-[#C86414]"
            ...
            <div>
              ...
              <div
                className="border-b transition-colors focus-within:border-[#00E5A8]"
                style={{ borderColor: "rgba(255,255,255,0.1)" }}
              >
                <input
                  id="c-email"
            ...
            <button
              type="submit"
              className="w-full rounded-full py-3.5 text-[13px] font-semibold uppercase tracking-widest text-[#050505] transition-all duration-300 hover:opacity-90 hover:shadow-[0_0_30px_rgba(200,100,20,0.4)]"
              style={{
