...
export default function Footer() {
    return (<footer className="section-padding relative border-t border-border bg-background py-16 md:py-24">
      <div className="mx-auto max-w-[1400px]">
        ...
        ].map((link) => (<a key={link.label} href={link.href} target="_blank" rel="noopener noreferrer" className="animated-underline text-[13px] text-muted transition-colors hover:text-primary">
                {link.label}
              </a>))}
          </div>
        </div>
