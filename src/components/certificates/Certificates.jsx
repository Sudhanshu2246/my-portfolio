    ...
    return (<section ref={sectionRef} className="section-padding relative bg-background-secondary py-32 md:py-48">
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {CERTIFICATES.map((cert) => (<div key={cert.name} className="cert-card group rounded-xl border border-border bg-card p-8 transition-all duration-500 hover:border-accent/30 hover:shadow-[0_0_40px_var(--color-glow)]">
